function sanitizeOptions(options) {
    const defaults = {
        ...
        sysscripts: 'builtin_encn_Collins,encn_Collins,envn_Cambridge,encn_Cambridge,encn_Oxford,fren_Cambridge,esen_Spanishdict,decn_Eudict,escn_Eudict,frcn_Eudict',
        udfscripts: '',
